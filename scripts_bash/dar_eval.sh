...
for randomize_temperature in "${temperatures[@]}"; do
    for num_sample_steps in "${steps[@]}"; do
        for guidance_scale in "${scales[@]}"; do
            ...
            output_dir="${prefix}_steps${num_sample_steps}_scale${guidance_scale}_temperature${randomize_temperature}"
            ...
            #     experiment.tokenizer_checkpoint=/home/ubuntu/ckpt/titok_l32.safetensors \
            #     experiment.generator_checkpoint=/home/ubuntu/dAR/temp/dar_titok_l32_main_more_warmup/checkpoint-250000/model.safetensors \
            ...
            # Run evaluation
            python3 evaluator/c2i_evaluator_torch.py /home/ubuntu/dataset/cached_features/VIRTUAL_imagenet256_labeled.npz ${output_dir}.npz
